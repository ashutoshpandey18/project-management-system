...
class TestGraphQLMutations(TestCase):
    ...
    def test_update_project_mutation(self):
        ...
        self.assertNotIn('errors', result)
        self.assertEqual(result['data']['updateProject']['project']['name'], 'Updated Project Name')
        self.assertEqual(result['data']['updateProject']['project']['description'], 'Updated project description')
        print("✓ Update project mutation works!")